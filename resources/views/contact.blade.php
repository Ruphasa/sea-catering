...
@section('content')
    <!-- Contact Us Section -->
    <div class="bg-blue-50 border border-blue-200 rounded-lg p-6 shadow-md mb-8">
        <h2 class="text-2xl font-semibold text-blue-700 mb-4">Contact Us</h2>
        <p class="text-gray-600 mb-4">Have questions? We're here to help! Reach out to us via:</p>
        <div class="flex items-center space-x-4">
            <a href="https://wa.me/6281234567890" target="_blank"
                class="flex items-center text-green-600 hover:text-green-700 transition duration-300">
